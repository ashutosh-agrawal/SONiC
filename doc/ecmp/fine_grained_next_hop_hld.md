...
MAX_NEXT_HOPS                         = max_next_hops                 ; Maximum number of nexthops that can be learned from route updates in dynamic-nhg mode. This field is not used in static-nhg mode or uf match_mode is nexthop-based.
```
